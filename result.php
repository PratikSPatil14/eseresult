...
$password = "";
$database = "vit";
$mysql_connection = mysqli_connect($server, $username, $password, 
$database);
if (!$mysql_connection)
{
echo '<div class="alert alert-danger" role="alert">
<h4 class="alert-heading">Failed to connect to database ... ' . 
mysqli_connect_error() . ' !!! </h4></div>';
die();
}
$sql_query = "INSERT INTO results(OS, CN, CS, AI, CGPA) VALUES($osTotal, 
$cnTotal, $csTotal, $aiTotal, $cgpa)";
if (!mysqli_query($mysql_connection, $sql_query))
{
echo '<div class="alert alert-danger" role="alert">
<h4 class="alert-heading">Failed to insert data to database !!! 
</h4></div>';
die();
}
